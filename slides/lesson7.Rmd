...
background-image: url("commander-yiker.jpeg")
...
background-image: url("twitchy-eye.gif")
background-size: contain
...
background-image: url("spiderman-samples.jpg")
background-size: contain
...
background-image: url("great-success.jpg")
background-size: contain

<span role="img" aria-label="Slide background shows: Borat with two thumbs up and caption of very-nice, great-success"></span>
