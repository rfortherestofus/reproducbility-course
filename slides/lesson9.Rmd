...
knitr::include_graphics('copy-r-to-word.jpg')
```


---

background-image: url("reproducibility-paper-top.png")
...
background-image: url("switching-rows-data.jpg")
background-size: contain
...
background-image: url("errors-transcribing.jpg")
background-size: contain
...
background-image: url("p-value-typos.png")
background-size: contain
...
background-image: url("error-superscripts.png")
background-size: contain
...
background-image: url("yikesyikesyikes.jpg")
background-size: contain
...
knitr::include_graphics('quarto-file-create.jpg')
```
...
knitr::include_graphics('r-code-chunk-screenshot.png')
```
...
knitr::include_graphics('quarto-screenshot-example.png')
```
...
knitr::include_graphics('insert-table-dialog.jpg')
```
...
knitr::include_graphics('insert-citation-screenshot.jpg')
```
...
knitr::include_graphics('chunk-options-quarto.jpg')
```
...
knitr::include_graphics('word-doc-template-quarto.jpg')
```
