...
background-image: url("variable-names-baby-i.jpeg")
...
background-image: url("variable-names-drake.png")
background-size: contain
...
background-image: url("hudson-code-descriptive-words.jpg")
background-size: contain
