...
knitr::include_graphics('images/ggplot-help-documentation.jpg')
```
...
knitr::include_graphics('images/aes-help-documentation.jpg')
```


---

background-image: url("images/onemillionrulesggplot.png")
